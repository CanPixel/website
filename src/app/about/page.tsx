    ...
    <div className="container mx-auto px-4 py-12">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
        <div className="md:col-span-1 flex flex-col items-center text-center">
          <Card className="w-full bg-card/50 backdrop-blur-sm p-4">
            <div className="relative w-48 h-48 mx-auto rounded-full overflow-hidden border-4 border-primary shadow-lg">
              <Image
              ...
              />
              <div className="absolute inset-0 grainy-effect opacity-10"></div>
            </div>
            <h2 className="font-headline text-3xl font-bold mt-6">Can Ur</h2>
            <p className="text-primary">Method Developer</p>
          ...
          <div className="relative border-l-2 border-primary/30 pl-8 space-y-12">
            ...
            {timelineEvents.map((event, index) => (
              <div key={index} className="relative">
                <div className="absolute -left-[42px] top-1.5 h-4 w-4 rounded-full bg-primary ring-4 ring-background"></div>
